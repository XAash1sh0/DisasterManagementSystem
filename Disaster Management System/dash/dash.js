document.addEventListener('DOMContentLoaded', () => {
 ...
 const cities = [
  ...
  const API_KEY = '74968931-2316-44eb-88ca-4499fa6a87a0'; // Replace with your IQAir API key

  // Fetch AQI for all cities and add markers
  cities.forEach(async ({ city, state }) => {
    try {
      const res = await fetch(`https://api.airvisual.com/v2/city?city=${encodeURIComponent(city)}&state=${encodeURIComponent(state)}&country=Nepal&key=${	
ba4bbb29-369e-4334-a21f-fd3629e3f7b2}`);
